...
namespace TheraBytes.BetterUi.Editor {
    ...
    public class BetterOffsetterEditor : UnityEditor.Editor {
        ...
        private void OnEnable() {
            ...
            helper.Register("Anchored Position X",
                "applyPosX",
                "customAnchorPosXSizers",
                "anchorPosXSizerFallback");

            helper.Register("Anchored Position Y",
                "applyPosY",
                "customAnchorPosYSizers",
                "anchorPosYSizerFallback");

            helper.RegisterSpace();

            helper.Register("Size Delta X",
                "applySizeX",
                "customSizeDeltaXSizers",
                "sizeDeltaXSizerFallback");

            helper.Register("Size Delta Y",
                "applySizeY",
                "customSizeDeltaYSizers",
                "sizeDeltaYSizerFallback");
        }
        ...
        private static BetterOffsetter AddBetterOffsetter(Transform transform) {
            ...
            while (ComponentUtility.MoveComponentUp(offsetter)) {
            }

            if (transform.gameObject.GetComponent<BetterLocator>() != null) {
                ComponentUtility.MoveComponentDown(offsetter);
            }
        ...
        public static void ConvertToBetterOffsetter(SizeDeltaSizer sizer) {
            ...
            SizeDeltaSizer.SettingsConfigCollection settingsCollection =
                settingsCollectionField.GetValue(sizer) as SizeDeltaSizer.SettingsConfigCollection;
            ...
            Vector2SizeConfigCollection sizeDeltaCollection =
                sizeDeltaCollectionField.GetValue(sizer) as Vector2SizeConfigCollection;
            ...
            FieldInfo offsetterSettingsCollectionField = offsetter.GetType()
                .GetField("customSettings", BindingFlags.NonPublic | BindingFlags.Instance);
            BetterOffsetter.SettingsConfigCollection offsetterSettingsCollection =
                offsetterSettingsCollectionField.GetValue(offsetter) as BetterOffsetter.SettingsConfigCollection;
            ...
            foreach (SizeDeltaSizer.Settings sizeDeltaSettings in settingsCollection.Items) {
                Vector2SizeModifier deltaSizer =
                    sizeDeltaCollection.GetItemForConfig(sizeDeltaSettings.ScreenConfigName, sizeDeltaFallback);

                CopyOverSizeDeltaSizerModifiers(sizeDeltaSettings,
                    deltaSizer,
                    out BetterOffsetter.Settings offsetterSettings,
                    out FloatSizeModifier sizeModX,
                    out FloatSizeModifier sizeModY);
            ...
            // fallback
            {
                CopyOverSizeDeltaSizerModifiers(settingsFallback,
                    sizeDeltaFallback,
                    out BetterOffsetter.Settings offsetterSettings,
                    out FloatSizeModifier sizeModX,
                    out FloatSizeModifier sizeModY);
