using TheraBytes.BetterUi.Editor.AlignDistribute;
using UnityEngine;
...
namespace TheraBytes.BetterUi.Editor {
    public class ToolsPage : WizardPage {
        ...
        public override string NameId => "ToolsPage";
        ...
        protected override void OnInitialize() {
            ...
            Add(new InfoWizardPageElement(
                "You can open the tools via the buttons below. However, you can also find them in the menu 'Tools -> Better UI'.",
                InfoType.InfoBox));

            Add(new SeparatorWizardPageElement());
            Add(new InfoWizardPageElement("Snap Anchors", InfoType.Header));
            Add(new InfoWithButtonWizardPageElement(
                "Snap Anchors allows you to move the anchors of selected UI elements to the desired position with one click. " +
                ...
                new InfoWithButtonWizardPageElement.ButtonInfo("Documentation",
                    () => Application.OpenURL("https://documentation.therabytes.de/better-ui/SnapAnchors.html"))));

            Add(new SeparatorWizardPageElement());

            Add(new InfoWizardPageElement("Align & Distribute", InfoType.Header));
            Add(new InfoWithButtonWizardPageElement(
                "Do sou want to align multiple object? Or do you want to distribute predefined objects evenly without using a Layout Group? " +
                "The Align & Distribute Tool will allow this along with a lot of configuration options to you.",
                new InfoWithButtonWizardPageElement.ButtonInfo("Open", AlignDistributeWindow.ShowWindow),
                new InfoWithButtonWizardPageElement.ButtonInfo("Documentation",
                    () => Application.OpenURL("https://documentation.therabytes.de/better-ui/AlignDistribute.html"))));

            Add(new SeparatorWizardPageElement());

            Add(new InfoWizardPageElement("Smart Parent", InfoType.Header));
            Add(new InfoWithButtonWizardPageElement(
                "Do you need to move or resize an object but keep the screen positions of its childs? " +
                ...
                new InfoWithButtonWizardPageElement.ButtonInfo("Documentation",
                    () => Application.OpenURL("https://documentation.therabytes.de/better-ui/")))); // TODO

            Add(new SeparatorWizardPageElement());

            Add(new InfoWizardPageElement("Pick Resolution", InfoType.Header));
            Add(new InfoWithButtonWizardPageElement(
                "Do you want to quickly switch between resolutions without having to open the drop down in the game view all the time? " +
                ...
                new InfoWithButtonWizardPageElement.ButtonInfo("Documentation",
                    () => Application.OpenURL("https://documentation.therabytes.de/better-ui/PickResolution.html"))));
        }
