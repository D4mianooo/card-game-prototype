...
namespace TheraBytes.BetterUi.Editor {
    public class FinalPage : WizardPage {
        ...
        public override string NameId => "FinalPage";
        protected override string NextButtonText => "Close";
        ...
        protected override void OnInitialize() {
            ...
            Add(new InfoWithButtonWizardPageElement(
                "If you have any trouble with Better UI, found a bug or have a feature request, feel free to write into the forums thread",
                "Open Thread in Unity Forum",
                () => Application.OpenURL("https://forum.unity.com/threads/better-ui.453808/")));
            ...
            Add(new SeparatorWizardPageElement());
            Add(new InfoWithButtonWizardPageElement(
                "If you want to watch some explanatory videos, visit the Asset Store page.\n" +
                "If you find Better UI useful you may consider to leave us a 5-Star review. We would be very thankful :)",
                "Open Asset Store Page",
                () => Application.OpenURL("https://assetstore.unity.com/packages/tools/gui/better-ui-79031")));
