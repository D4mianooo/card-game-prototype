...
namespace TheraBytes.BetterUi.Editor {
    public class WelcomePage : WizardPage {
        ...
        public override string NameId => "WelcomePage";
        protected override string NextButtonText => "Start Setup Wizard";
        ...
        protected override void OnInitialize() {
            ...
            if (!skippingIsRecommended) {
                Add(new InfoWizardPageElement(
                    "It is recommended to follow this wizard before using any features of Better UI.\n" +
            ...
            Add(new ValueWizardPageElement<bool>("SkipWizard",
                    (o, v) =>
                    {
                        if (GUILayout.Button("Skip Wizard")) {
                            if (skippingIsRecommended
                                || EditorUtility.DisplayDialog("Skip Wizard",
