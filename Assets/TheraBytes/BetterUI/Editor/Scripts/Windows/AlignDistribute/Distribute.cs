...
namespace TheraBytes.BetterUi.Editor.AlignDistribute {
    public static class Distribute {
        ...
        public static void DistributeSelection(AlignMode alignMode, DistanceOption distanceOption, SortOrder sortOrder,
                                               float paddingLeftBottomPixels, float paddingRightTopPixels) {
            ...
            var selection = GetSortedSelection();
